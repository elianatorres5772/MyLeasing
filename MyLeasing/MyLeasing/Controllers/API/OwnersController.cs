    ...
    public class OwnersController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetOwnerByEmailAsync(EmailRequest request)
        {
            ...
            var response = new OwnerResponse
            {
                ...
                Properties = owner.Properties?.Select(p => new PropertyResponse // este  signo de ig
                {
                    Address = p.Address,
        ...
        private LesseeResponse ToLessesResponse(Lessee lessee) // se esta importando una clase 
        {
